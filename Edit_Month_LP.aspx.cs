...
namespace MqWebApp2
{
    public partial class Edit_Month_LP : System.Web.UI.Page
    {
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from month_detail where month_year='" + DropDownList1.Text + "' AND supplier_type='LP' ", con);
        ...
        protected void BtnEditMonth_Click(object sender, EventArgs e)
        {
        ...
        protected void BtnDeleteMonth_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Write("<script>alert('The month details has been deleted.')</script>");
            Response.AddHeader("REFRESH", "1;URL=Edit_Month_LP");
        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Write("<script>alert('The month details has been updated.')</script>");
            Response.AddHeader("REFRESH", "1;URL=Edit_Month_LP");
        }
