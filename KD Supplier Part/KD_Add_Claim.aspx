<%@ Page Title="(KD) Add New Claim" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KD_Add_Claim.aspx.cs" Inherits="MqWebApp2.KD_Supplier_Part.KD_Add_Claim" %>
    ...
    <div class="container">
        ...
        <div class="container ">
            ...
            <section id="btnaddsupplier" class="btnaddsupplier">
                ...
                <a class="btnaddsupplier-btn" href="/KD Supplier Part/KD_ImportExcel.aspx">Import Excel File</a>
            </section>
            ...
            <div class="form-list ">
              ...
              <!-- Supplier code -->
                <div class="col-lg-6 form-group">
                    ...
                    <asp:SqlDataSource ID="SqlDataSupplierCode" runat="server" ConnectionString="<%$ ConnectionStrings:MQWebAppConnectionString %>" SelectCommand="SELECT [supplier_code] FROM [supplier_details] WHERE ([supplier_type] = @supplier_type)">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="KD" Name="supplier_type" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                ...
                <div class="col-lg-12 form-group">
                    ...
                    <asp:SqlDataSource ID="SqlDataKDSupplierName" runat="server" ConnectionString="<%$ ConnectionStrings:MQWebAppConnectionString %>" SelectCommand="SELECT [supplier_name] FROM [supplier_details] WHERE ([supplier_type] = @supplier_type)">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="KD" Name="supplier_type" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
              ...
              <asp:TextBox runat="server"  Enabled="true" ID="supplier_type1" Text="KD" CssClass="form-control" placeholder="" Visible="False"></asp:TextBox>
