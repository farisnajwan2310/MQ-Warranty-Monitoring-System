...
{
    public partial class KD_Edit_Claim : System.Web.UI.Page
    {
        ...
        protected void SessionBind()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from claim_record where month_year='" + currentMonth + "' AND supplier_type='KD' ORDER BY status_claim DESC ,supplier_code ASC ", con);
        ...
        protected void SearchCodeBtn_Click(object sender, EventArgs e)
         {
            ...
            SqlCommand cmd = new SqlCommand("Select * from claim_record where month_year='" + DropDownApplicationMonth.Text + "' AND supplier_code ='" + SearchSuppCode.Text + "' AND supplier_type='KD' ORDER BY status_claim DESC ,supplier_code ASC ", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
            GridView1.DataSource = dt;
        ...
        protected void SelectBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Display All Record Total (KD) at top of the form
                con.Open();
                SqlCommand total_amount_collected = new SqlCommand("Select sum(first_approve_amount+second_approve_amount+third_approve_amount) from claim_record where month_year='" + DropDownApplicationMonth.Text + "' AND supplier_code='" + UpdateSupplierCode.Text + "' AND supplier_type='KD'", con);
        ...
        protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from claim_record where month_year='" + DropDownApplicationMonth.Text + "' AND supplier_type='KD' ORDER BY status_claim DESC ,supplier_code ASC ", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
            GridView1.DataSource = dt;
        ...
        protected void btndelete_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM claim_record WHERE month_year='" + UpdateMonthTextBox.Text + "' AND supplier_code='" + UpdateSupplierCode.Text + "' AND status_claim='" + status_claim.Text + "' AND supplier_type='KD' ";
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Write("<script>alert('The record has been deleted.')</script>");
            Response.AddHeader("REFRESH", "1;URL=KD_Edit_Claim");
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //Rename column header through cell number
        ...
        {
            //Setvalue of javascript from front end for calculation display
