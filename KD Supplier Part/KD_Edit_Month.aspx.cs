...
{
    public partial class Kd_add_application_month : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("REFRESH", "1;URL=KD_Edit_Month");
        }

        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            //This method to display month selected at the dropdownlist
            SqlCommand cmd = new SqlCommand("Select * from month_detail where month_year='" + DropDownList1.Text + "' AND supplier_type='KD' ", con);
        ...
        {
            //To link data in the data table to the column form
