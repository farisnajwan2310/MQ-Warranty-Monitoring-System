<%@ Page Title="(LP) Edit Claim Record" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditRecordLP.aspx.cs" Inherits="MqWebApp2.EditRecordLP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <section id="breadcrumbs" class="breadcrumbs lineLP">
      <div class="container">
        ...
        <li><a href="LP_Supplier.aspx">LP Supplier</a></li>
    ...
    <div class="container">
        ...
        <div class="yeardropdown">
          <asp:Label runat="server"><b>Pick Application Month:</b></asp:Label><br />
            <asp:DropDownList ID="DropDownList3" CssClass="yeardropbtn" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged" runat="server" DataSourceID="SqlDataSource1" DataTextField="month_year" DataValueField="month_year" AutoPostBack="True" AppendDataBoundItems="True">
                <Items>
        ...
        <!--=====Link to export/generate data from the system =====-->
         <i class="bi bi-file-earmark-ruled" style="color: #63e07a;"></i><a class="btnaddsupplier-btn" href="LP_ExportData.aspx">  Generate Data</a>
        ...
        <div class="section-title">
              <h2>Edit LP Supplier Claim<asp:Label ID="MonthEdit" runat="server" Text=""></asp:Label></h2>
        </div><!--End of title-->
        ...
        <asp:TextBox ID="SearchSuppCode" CssClass="offset-1" Visible="false" runat="server"></asp:TextBox>
        <asp:Button ID="SearchCodeBtn" runat="server" Text="Search" Visible="false" OnClick="SearchCodeBtn_Click" />
        <asp:Button ID="RefreshBtn" runat="server" Text="Refresh Grid" Visible="false" OnClick="DropDownList3_SelectedIndexChanged"  />
        ...
        <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" PageSize="7" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:LinkButton ID="SelectButton" runat="server" CausesValidation="false" OnClick="SelectRecord_Click" CommandName="" Text="Select"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        ...
        </asp:GridView><asp:Label ID="PageNumber" Visible="false" runat="server" Text=""></asp:Label>
        </div>
          ...
          <div class="container mt-6">
            ...
            <div id="here" class="form-list ">
              ...
              <!-- Supplier code -->
               ...
               <!--Total Claim-->
                <div class="col-md-6 form-group">
                    ...
                    <asp:TextBox runat="server"  Enabled="true" ID="total_claim" ClientIDMode="Static" TextMode="Number" Text="0" CssClass="form-control" placeholder="Write Total Claim here..."></asp:TextBox>
                </div>
                <!--Total Amount-->
                <div class="col-md-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="total_amount"><b>Total Amount (RM):</b></asp:Label><br />
                    <asp:TextBox runat="server"  Enabled="true" ID="total_amount" Text="0" ClientIDMode="Static" CssClass="form-control" placeholder="Write Total Claim(RM) here..."></asp:TextBox>
                </div>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <asp:TextBox runat="server"  Enabled="true" ID="approved_amount_1st" ClientIDMode="Static" Text="0" CssClass="form-control" placeholder="Write Approved Amount here..."></asp:TextBox>
                </div>
                <div class="col-md-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="approved_1st"><b> Quantity Approved:</b></asp:Label><br />
                    <asp:TextBox runat="server"  Enabled="true" ID="approved_1st" TextMode="Number" ClientIDMode="Static" Text="0" CssClass="form-control" placeholder="Write Approved Quantity here..."></asp:TextBox>
                </div>
                <div class="col-md-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="rejected_amount_1st"><b> Rejected Amount (RM):</b></asp:Label><br />
                    <asp:TextBox runat="server"  Enabled="true" ID="rejected_amount_1st" ClientIDMode="Static"  Text="0" CssClass="form-control" placeholder="Write Rejected Amount here..."></asp:TextBox>
                </div>
                <div class="col-md-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="rejected_1st"><b> Quantity Rejected:</b></asp:Label><br />
                    <asp:TextBox runat="server"  Enabled="true" ID="rejected_1st" TextMode="Number" ClientIDMode="Static" Text="0" CssClass="form-control" placeholder="Write Rejected Quantity here..."></asp:TextBox>
                </div>
                <div class="col-md-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="amount_1st"><b>Total Amount:</b></asp:Label><br />
                    <asp:TextBox runat="server"  Enabled="true" ID="amount_1st" Text="0" ClientIDMode="Static" CssClass="form-control" ReadOnly="True" placeholder="Write Total Amount here..."></asp:TextBox>
                </div>
                <div class="col-md-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="quantity_1st"><b>Total Quantity:</b></asp:Label><br />
                    <asp:TextBox runat="server"  Enabled="true" ID="quantity_1st" TextMode="Number" ClientIDMode="Static" Text="0" CssClass="form-control" ReadOnly="True" placeholder="Write Total Quantity here..."></asp:TextBox>
                </div>
                <div class="col-md-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="pending_amount_1st"><b> Pending Amount(RM):</b></asp:Label><br />
                    <asp:TextBox runat="server"  Enabled="true" ID="pending_amount_1st" ClientIDMode="Static" Text="0" CssClass="form-control" ReadOnly="True" placeholder="Write Pending Amount here..."></asp:TextBox>
                </div>
                <div class="col-md-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="pending_1st"><b> Quantity Pending:</b></asp:Label><br />
                    <asp:TextBox runat="server"  Enabled="true" ID="pending_1st" TextMode="Number" ClientIDMode="Static" Text="0" ReadOnly="True" CssClass="form-control" placeholder="Write Quantity Pending here..."></asp:TextBox>
                </div>
              ...
              <div class="col-md-6 form-group">
                  ...
                  <asp:TextBox runat="server"  Enabled="true" ID="amount_approved_2nd" ClientIDMode="Static"  Text="0" CssClass="form-control" placeholder="Write Total Quantity here.."></asp:TextBox>
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                  ...
                  <asp:TextBox runat="server"  Enabled="true" ID="amount_rejected_2nd" ClientIDMode="Static" Text="0" CssClass="form-control"  placeholder="Write Rejected amount here.."></asp:TextBox>
                </div>
              <div class="col-md-6 form-group">
              ...
              <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                  ...
                  <asp:TextBox runat="server"  Enabled="true" ID="pending_2nd" TextMode="Number" Text="0" CssClass="form-control" ReadOnly="True" ClientIDMode="Static" placeholder="Write Pending Quantity here.."></asp:TextBox>
                </div>
                <div class="col-lg-3 form-group">
                <p> </p>
                  <asp:Label runat="server" AssociatedControlID="date_2nd"><b>  2nd Submission Date:</b></asp:Label><br />
                  <asp:TextBox runat="server"  Enabled="true" ID="date_2nd" TextMode="Date" AutoPostBack="false" CssClass="form-control" placeholder="Write Date 2nd Claim here.."></asp:TextBox>
               </div>
              ...
              <div class="col-md-6 form-group">
                  ...
                  <asp:TextBox runat="server"  Enabled="true" ID="quantity_3rd" TextMode="Number" Text="0" ReadOnly="True" CssClass="form-control" ClientIDMode="Static" placeholder=""></asp:TextBox>
                </div>
              <div class="col-md-6 form-group">
              ...
              <asp:Button Text="Delete" ID="btndelete"  CssClass="formSetting2 offset-2 mt-4" onclientclick="return confirm('Are you sure to delete this data?')" OnClick="btndelete_Click"  Width="170px" runat="server" />
              <asp:Button Text="Update" ID="btnupdate" OnClick="btnupdate_Click"  CssClass="formSetting2 offset-3 mt-4" Width="170px" runat="server" />
