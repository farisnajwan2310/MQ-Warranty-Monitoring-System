...
namespace MqWebApp2
{
    public partial class LP_ExportData : System.Web.UI.Page
    {
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from claim_record where month_year='" + DropDownList1.Text + "' AND supplier_type='LP' ORDER BY status_claim DESC ", con);
        ...
        private void ExportGridToExcel()
        {
            ...
            Response.Charset = "";
            string FileName = "Data LP - " + DropDownList1.Text + ".xls";
