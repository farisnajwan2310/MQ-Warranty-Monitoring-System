...
{
    public partial class PUD_Add_Claim : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            SqlCommand DropDownMonthToCollectDate = new SqlCommand("select collection_date from month_detail where month_year='" + DropDownMonthYear.Text + "' AND supplier_type='PUD Claim' ", con);
        ...
        {
            con.Open();
            SqlCommand DropDownCodeToSupplierName = new SqlCommand("select supplier_name from supplier_details where supplier_code='" + DropDownSupplierCode.Text + "'  ", con);
        ...
        protected void AddClaimRecord(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.AddHeader("REFRESH", "1;URL=PUD_Add_Claim");
