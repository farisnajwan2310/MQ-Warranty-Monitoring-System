<%@ Page Title="(PUD) Edit Claim" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PUD_Edit_Claim.aspx.cs" Inherits="MqWebApp2.PUD_Claim.PUD_Edit_Claim" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="yeardropdown">
            ...
            <asp:DropDownList ID="DropDownApplicationMonth" CssClass="yeardropbtn" runat="server" OnSelectedIndexChanged="DropDownApplicationMonth_SelectedIndexChanged" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="month_year" DataValueField="month_year" AutoPostBack="True">
                <Items>
        ...
        <i class="bi bi-file-earmark-ruled" style="color: #63e07a;"></i><a class="btnaddsupplier-btn" href="PUD_ExportData.aspx">  Generate Data</a>

        <div class="section-title">
              <h2>Edit PUD Claim Record</h2>
        </div><!--End of title-->
        ...
        <div class="table-group">
            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="True" PageSize="7">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" CommandName="" OnClick="SelectBtn_Click" Text="Select"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                    ...
                    <div class="center">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 form-group">
                              ...
                              <asp:TextBox runat="server"  Enabled="true" ID="quantity_3rd" TextMode="Number" Text="0" CssClass="form-control" ReadOnly="True" ClientIDMode="Static" placeholder=""></asp:TextBox>
                            </div>
                          <div class="col-md-6 form-group">
                          ...
                          <asp:TextBox runat="server"  Enabled="true" ID="supplier_type1"  CssClass="form-control" Text="PUD Claim" Visible="False"></asp:TextBox>
