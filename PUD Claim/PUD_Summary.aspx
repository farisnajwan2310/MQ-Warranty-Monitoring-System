<%@ Page Title="(PUD) Summary Total Amount" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PUD_Summary.aspx.cs" Inherits="MqWebApp2.PUD_Claim.PUD_Summary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="breadcrumbs" class="breadcrumbs linePUD">
          <div class="container">
            ...
            <li><a href="PUD_Claim">PUD Claim Menu</a></li>
    ...
    <div class="container">
        ...
        <div class="yeardropdown">
            <asp:Label runat="server" AssociatedControlID="DropDownApplicationMonth1"><b>Pick Application Month:</b></asp:Label><br />
            <asp:DropDownList ID="DropDownApplicationMonth1" CssClass="yeardropbtn" OnSelectedIndexChanged="DropDownApplicationMonth1_SelectedIndexChanged" runat="server" AutoPostBack="True" AppendDataBoundItems="True" DataSourceID="DropDownMonthApplication" DataTextField="month_year" DataValueField="month_year">
                <Items>
                    <asp:ListItem Text="Select Month" Value="" Enabled="True" Hidden="True" />
                </Items>
            </asp:DropDownList>
            <asp:SqlDataSource ID="DropDownMonthApplication" runat="server" ConnectionString="<%$ ConnectionStrings:MQWebAppConnectionString %>" SelectCommand="SELECT [month_year] FROM [month_detail] WHERE ([supplier_type] = @supplier_type) ORDER BY [collection_date] DESC">
                <SelectParameters>
            ...
            <div class="col-lg-12 mt-4">
                <div class="col-lg-12 cardpercentclaim-body2">
                    ...
                    <div class="col-lg-6 mt-4 text-center ">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:MQWebAppConnectionString %>" SelectCommand="select  status_claim,count(status_claim) as Status1 from claim_record where supplier_type='PUD Claim' AND month_year='Nov-2020' group by status_claim"></asp:SqlDataSource>
                        
                    </div>
                    <div class="col-lg-6 mt-4">
                        <h3>Summary PUD Claim in <asp:Label ID="SummaryLabel" runat="server" Text=""></asp:Label></h3>
                   ...
                   <div class="col-lg-12 mt-4"> <!--==Lower Part==-->
                        <div class="col-lg-3 statuspercent text-center left-line-blind">
                           <div class="col-lg-12 status-digit">
                               <h4><asp:Label ID="PUDAmountAll" runat="server" Text="-"></asp:Label></h4>
                               <p>Amount</p>
                           </div>
                           <div class="col-lg-12 status-digit">
                               <h4><asp:Label ID="PUDQuantityAll" runat="server" Text="-"></asp:Label></h4>
                               <p>Case</p>
                           </div>
