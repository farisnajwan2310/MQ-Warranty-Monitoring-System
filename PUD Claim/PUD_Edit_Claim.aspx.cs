...
{
    public partial class PUD_Edit_Claim : System.Web.UI.Page
    {
        ...
        {
            //Substitute current session to string variable.
            String currentMonth = Session["monthPUD"].ToString();

            SqlCommand cmd = new SqlCommand("Select * from claim_record where month_year='" + currentMonth + "' AND supplier_type='PUD Claim' ORDER BY status_claim DESC ,supplier_code ASC ", con);
        ...
        {
            //This event executed when the session is not null. If the session is not set / null, it will executed when the dropdown has been set
            String currentMonth = Session["monthPUD"].ToString();

            SqlCommand cmd = new SqlCommand("Select * from claim_record where month_year='"+ currentMonth +"' AND supplier_code ='" + SearchSuppCode.Text + "' AND supplier_type='PUD Claim' ORDER BY status_claim DESC ,supplier_code ASC ", con);
             SqlDataAdapter da = new SqlDataAdapter(cmd);
             DataTable dt = new DataTable();
             da.Fill(dt);
             GridView1.DataSource = dt;
        ...
        protected void SelectBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //The method to display record selected at the textbox display
                ...
                date_claim.Text = Convert.ToDateTime(GridView1.Rows[rowindex].Cells[5].Text).ToString("yyyy-MM-dd");
                ...
                con.Open();
                SqlCommand total_amount_collected = new SqlCommand("Select sum(first_approve_amount+second_approve_amount+third_approve_amount) from claim_record where month_year='" + DropDownApplicationMonth.Text + "' AND supplier_code='" + UpdateSupplierCode.Text + "' AND supplier_type='PUD Claim' ", con);
                ...
                TotalCollected.Text = totalamountcollected;
                con.Close();
            }
            catch (Exception)
            {
        ...
        protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from claim_record where month_year='" + DropDownApplicationMonth.Text + "' AND supplier_type='PUD Claim' ORDER BY status_claim DESC ,supplier_code ASC ", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
            GridView1.DataSource = dt;
        ...
        protected void CalculationFirst()
        {
            ...
            //this method called to calculate the first total amount pending
        ...
        protected void CalculationSecond()
        {
            ...
            //this method called to calculate the second total amount pending
        ...
        protected void CalculationThird()
        {
            ...
            //this method called to calculate the third total amount pending
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("REFRESH", "1;URL=PUD_Edit_Claim");
        }
        ...
        protected void btndelete_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "DELETE FROM claim_record WHERE month_year='" + UpdateMonthTextBox.Text + "' AND supplier_code='" + UpdateSupplierCode.Text + "' AND status_claim='" + status_claim.Text + "' AND supplier_type='PUD Claim' ";
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Write("<script>alert('The details has been deleted.')</script>");
            Response.AddHeader("REFRESH", "1;URL=PUD_Edit_Claim");
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //Rename header column name by finding the number of cells
