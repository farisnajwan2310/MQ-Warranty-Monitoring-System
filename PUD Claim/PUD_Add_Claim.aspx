<%@ Page Title="(PUD) Add Claim" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PUD_Add_Claim.aspx.cs" Inherits="MqWebApp2.PUD_Claim.PUD_Add_Claim" %>
    ...
    <div class="container">
        ...
        <div class="container ">
            ...
            <div class="section-title">
              <h2>Add Claim to PUD Supplier</h2>
            ...
            <section id="btnaddsupplier" class="btnaddsupplier">
                ...
                <a class="btnaddsupplier-btn" href="/PUD Claim/PUD_ImportExcel.aspx">Import Excel File.</a>
            </section>
            ...
            <div class="form-list ">
              ...
              <!-- Supplier code -->
                <div class="col-lg-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="DropDownSupplierCode"><b>Supplier Code* :</b></asp:Label> <br />
                    <asp:SqlDataSource ID="SqlDataSupplierCode" runat="server" ConnectionString="<%$ ConnectionStrings:MQWebAppConnectionString %>" SelectCommand="SELECT [supplier_code] FROM [supplier_details] ORDER BY [supplier_type] DESC, [supplier_code]">
                    </asp:SqlDataSource>
                    <asp:DropDownList ID="DropDownSupplierCode" runat="server" CssClass="dropdownform" DataSourceID="SqlDataSupplierCode" DataTextField="supplier_code" DataValueField="supplier_code" AutoPostBack="True" OnSelectedIndexChanged="DropDownSupplierCode_SelectedIndexChanged" AppendDataBoundItems="True">
                    <Items>
                ...
                <div class="col-lg-12 form-group">
                    <asp:Label runat="server" AssociatedControlID="DropDownSupplierName"><b>Supplier Name* :</b></asp:Label><br />
                    <asp:SqlDataSource ID="SqlDataKDSupplierName" runat="server" ConnectionString="<%$ ConnectionStrings:MQWebAppConnectionString %>" SelectCommand="SELECT [supplier_name] FROM [supplier_details] ORDER BY [supplier_type] DESC, [supplier_name]">
                    </asp:SqlDataSource>
                    <asp:DropDownList ID="DropDownSupplierName" runat="server" CssClass="dropdownform" DataSourceID="SqlDataKDSupplierName" DataTextField="supplier_name" DataValueField="supplier_name" AppendDataBoundItems="True">
                        <Items>
              ...
              <!--Total Claim-->
                <div class="col-md-6 form-group">
                    ...
                    <asp:TextBox runat="server"  Enabled="true" ID="total_claim" TextMode="Number" ClientIDMode="Static" Text="0" CssClass="form-control" placeholder="Write Total Claim here..."  AutoPostBack="False"></asp:TextBox>
                </div>
                <!--Total Amount-->
                <div class="col-md-6 form-group">
                    <asp:Label runat="server" AssociatedControlID="total_amount"><b>Total Amount* :</b></asp:Label><br />
                    <asp:TextBox runat="server"  Enabled="true" ID="total_amount" Text="0" CssClass="form-control" ClientIDMode="Static" placeholder="Write Total Claim(RM) here..."  AutoPostBack="False"></asp:TextBox>
                </div>
              ...
              <asp:TextBox runat="server"  Enabled="true" ID="supplier_type1" Text="PUD Claim" CssClass="form-control" placeholder="" Visible="False"></asp:TextBox>
