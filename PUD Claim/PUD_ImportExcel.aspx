<%@ Page Title="(PUD) Import Excel Data" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PUD_ImportExcel.aspx.cs" Inherits="MqWebApp2.PUD_Claim.PUD_ImportExcel" %>
    ...
    <section id="breadcrumbs" class="breadcrumbs linePUD">
              <div class="container">
                ...
                <ol>
                  ...
                  <li><a href="PUD_Add_Claim.aspx"> Add new claim</a></li>
      ...
      <p>Download :  
        ...
        <div class="card-excelupload">
           ...
           <p>Please drag/upload file here.</p>
            <asp:DropDownList ID="DropDownApplicationMonth" AppendDataBoundItems="true" runat="server" DataSourceID="SqlDataSource1" DataTextField="month_year" DataValueField="month_year">
                <Items>
            ...
            <div class="text-center">
                ...
                <asp:Button ID="UploadExcel"  runat="server" CssClass="btn-excelupload" OnClick="UploadExcel_Click" Text="Upload File" /><br />       
